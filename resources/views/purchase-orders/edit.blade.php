        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center space-x-4">
                ...
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                    {{ __('Editar Orden') }} #{{ $purchaseOrder->order_number }}
                </h2>
            </div>
        </div>
    </x-slot>
                ...
                <div class="space-y-6">
                        ...
                        <div class="p-6 grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <select name="supplier_id" 
                                        class="block w-full rounded-lg border-gray-300 focus:ring-2 focus:ring-orange-500 @error('supplier_id') border-red-300 @enderror" 
                                        required>
                            ...
                            <div>
                                ...
                                <select name="destination_warehouse_id" 
                                        class="block w-full rounded-lg border-gray-300 focus:ring-2 focus:ring-orange-500 @error('destination_warehouse_id') border-red-300 @enderror" 
                                        required>
                                    <option value="">Seleccionar...</option>
                            ...
                            <div class="space-y-4">
                                <template x-for="(item, index) in items" :key="index">
                                    <div class="border border-gray-200 rounded-lg p-4 bg-gray-50">
                                        ...
                                        <!-- Input oculto para ID si existe -->
                                        ...
                                        <div class="mt-3 text-right">
                                            ...
                                            <span class="text-lg font-bold text-orange-600" x-text="'$' + item.subtotal.toFixed(2)"></span>
                                        </div>
                                    </div>
                                </template>
                            </div>
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <textarea name="notes" 
                                              rows="6"
                                              class="block w-full rounded-lg border-gray-300 focus:ring-2 focus:ring-orange-500"
                                              placeholder="Observaciones adicionales...">{{ old('notes', $purchaseOrder->notes) }}</textarea>
                                </div>
                                ...
                                <div class="bg-gradient-to-br from-orange-50 to-red-50 rounded-lg p-6">
                                    ...
                                    <div class="space-y-3">
                                        ...
                                        <div class="flex justify-between items-center pt-2">
                                            ...
                                            <span class="text-2xl font-bold text-orange-600" x-text="'$' + total.toFixed(2)"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="flex justify-end gap-3">
                        ...
                        <button type="submit" 
                                ...
                                class="px-6 py-3 bg-orange-600 hover:bg-orange-700 disabled:bg-gray-400 text-white font-semibold rounded-lg transition-all">
                            Actualizar Orden
                        </button>
                    </div>
                </div>
