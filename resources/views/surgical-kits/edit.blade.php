<x-app-layout>
    ...
    <div class="py-6">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div x-data="surgicalKitForm()" x-init="initProducts()" class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
    ...
    <script>
        function surgicalKitForm() {
            return {
                ...
                initProducts() {
                    this.products = @json($surgicalKit->items->map(function($item) {
                        return [
