            ...
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-600">
                        {{ __('Registra una nueva entidad legal') }}
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div class="px-6 py-4 bg-gradient-to-r from-indigo-50 to-purple-50 border-b border-gray-200">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold text-gray-900">{{ __('Datos de la Entidad Legal') }}</h3>
                            <p class="text-sm text-gray-600">{{ __('Completa los campos requeridos') }}</p>
                        </div>
                    </div>
                </div>

                <form action="{{ route('legal-entities.store') }}" method="POST" class="p-6">
                    @csrf
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="notes" 
                                      ...
                                      placeholder="Información adicional relevante...">{{ old('notes') }}</textarea>
                            @error('notes')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
