            ...
            <div class="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
                <div class="p-6">
                    ...
                    <form action="{{ route('categories.update', $category->id) }}" method="POST">
                        @csrf
                        @method('PUT') {{-- Importante para usar el método UPDATE del controlador --}}
                        ...
                        <div class="mb-5">
                            ...
                            <textarea name="description" id="description" rows="3"
                                      ...
                                      placeholder="Detalles sobre qué tipo de productos abarca esta clasificación.">{{ old('description', $category->description) }}</textarea>
                            @error('description')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
