...
<nav @mouseenter="desktopSidebarOpen = true" @mouseleave="desktopSidebarOpen = false"
     x-data="{ 
         inventoryMenuOpen: {{ request()->routeIs('products.*') || request()->routeIs('items.*') || request()->routeIs('product-units.*') || request()->routeIs('product_layouts.*') || request()->routeIs('inventory-counts.*') || request()->routeIs('inventory.movements') ? 'true' : 'false' }},
