...
<nav @mouseenter="desktopSidebarOpen = true" @mouseleave="desktopSidebarOpen = false"
     x-data="{ 
         inventoryMenuOpen: {{ request()->routeIs('products.*') || request()->routeIs('items.*') || request()->routeIs('sets.*') || request()->routeIs('product-units.*') || request()->routeIs('product_layouts.*') || request()->routeIs('inventory-counts.*') || request()->routeIs('inventory.movements') || request()->routeIs('kits.assemble') ? 'true' : 'false' }},
                ...
                <div class="relative">
                    ...
                    <div x-show="inventoryMenuOpen && desktopSidebarOpen" 
                        ...
                        <a href="{{ route('items.index') }}" 
                            class="flex items-center space-x-2 px-3 py-2 text-sm text-gray-700 hover:bg-indigo-50 hover:text-indigo-600 transition-colors duration-150 {{ request()->routeIs('items.*') ? 'bg-indigo-50 text-indigo-600' : '' }}">
                            <i class="fas fa-microscope fa-fw text-sm"></i>
                        ...
                        <a href="{{ route('kits.index') }}" 
                            class="flex items-center space-x-3 pl-6 pr-3 py-2 text-sm font-medium rounded-r-lg transition-all duration-200 {{ request()->routeIs('kits.assemble') ? 'bg-indigo-50 text-indigo-600 border-l-2 border-indigo-600 -ml-0.5' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                            <i class="fas fa-clipboard-check fa-fw text-sm"></i>
                            <span class="truncate">Armado de Kits</span>
                        </a>
                    ...
                    <div x-show="!desktopSidebarOpen && inventoryMenuOpen" 
                        ...
                        <a href="{{ route('items.index') }}" 
                            class="flex items-center space-x-3 pl-6 pr-3 py-2 text-sm font-medium rounded-r-lg transition-all duration-200 {{ request()->routeIs('items.*') ? 'bg-indigo-50 text-indigo-600 border-l-2 border-indigo-600 -ml-0.5' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                            <i class="fas fa-microscope fa-fw text-sm"></i>
                            <span class="truncate">Instrumental Médico</span>
                        </a>
                        <a href="{{ route('sets.index') }}" ...>
                                <i class="fas fa-layer-group fa-fw text-sm"></i>
                            ...
                            <a href="{{ route('kits.index') }}" 
                            class="flex items-center space-x-2 px-3 py-2 text-sm text-gray-700 hover:bg-indigo-50 hover:text-indigo-600 transition-colors duration-150 {{ request()->routeIs('kits.assemble') ? 'bg-indigo-50 text-indigo-600' : '' }}">
                                <i class="fas fa-clipboard-check fa-fw text-sm"></i>
                                <span>Armado de Kits</span>
                            </a>
                        <a href="{{ route('product-units.index') }}" 
