    ...
    <div class="py-8">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
                <div class="p-6">
                    <h3 class="text-xl font-semibold text-gray-900 mb-4">{{ __('Información del Proveedor/Fabricante') }}</h3>
                    ...
                    <form action="{{ route('manufacturers.store') }}" method="POST">
                        ...
                        <div class="mb-5">
                            ...
                            <input type="text" name="name" id="name" required
                                   ...
                                   placeholder="Ej: Johnson & Johnson, Stryker Corporation">
                            @error('name')
                        ...
                        <div class="mb-5">
                            ...
                            <textarea name="description" id="description" rows="3"
                                      ...
                                      placeholder="Información de contacto, sede principal o acuerdos clave.">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
